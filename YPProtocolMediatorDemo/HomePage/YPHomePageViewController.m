...
//    [[YPProtocolMediator shareInstance] bindModule:self withDelegateProtocol:@protocol(YPUserCenterDelegate)];
...
- (void)loginAccountButtonEvent:(UIButton *)button {
    ...
    UIViewController * loginViewController = [YPMediatorPort(YPLoginPort) yp_excuteSelector:@selector(loginViewController)];
